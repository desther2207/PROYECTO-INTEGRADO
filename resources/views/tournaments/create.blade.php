<x-app-layout>
    <x-self.base>
        ...
        <div class="container mx-auto p-4">
            ...
            <form action="{{ route('tournaments.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                    ...
                    <div class="border-b border-gray-700 pb-12">
                        ...
                        <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-8">
                            ...
                            <div>
                                ...
                                <input id="registration-range" name="registration-range" type="text" placeholder="Selecciona rango de fechas"
