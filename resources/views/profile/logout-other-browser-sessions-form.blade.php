<x-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario, puedes cerrar sesión en todos tus otros navegadores y dispositivos. Algunas de tus sesiones recientes se muestran a continuación, pero esta lista puede no ser exhaustiva. Si crees que tu cuenta ha sido comprometida, también deberías actualizar tu contraseña.') }}
        </div>
        ...
        <x-dialog-modal wire:model.live="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor, introduce tu contraseña para confirmar que deseas cerrar la sesión en tus otros navegadores y dispositivos.') }}
