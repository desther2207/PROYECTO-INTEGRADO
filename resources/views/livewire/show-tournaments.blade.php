<x-self.base>
    <div class="p-4" role="main" aria-labelledby="titulo-torneos">
        ...
        <div class="mb-6" role="search" aria-label="Filtrar torneos">
            <form wire:submit.prevent="render" class="flex flex-wrap gap-4 items-end">
                ...
                <div>
                    ...
                    <select wire:model.live="province" id="province"
                        class="mt-1 px-3 py-2 text-black rounded border border-gray-300"
        ...
        <article class="flex flex-col md:flex-row w-full my-6 bg-white shadow-sm border border-slate-200 rounded-lg overflow-hidden min-h-[300px]" role="region" aria-labelledby="tournament-{{ $tournament->id }}">
            <!-- Imagen -->
